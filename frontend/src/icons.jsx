...
export const IcoGauge = (p) => <S {...p}><path d="M12 14a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" /><path d="m13.4 10.6 3.8-3.8" /><path d="M3.5 18a9.5 9.5 0 1 1 17 0" /></S>;
...
export const IcoNodes = (p) => <S {...p}><circle cx="12" cy="12" r="2.6" /><circle cx="5" cy="5" r="2" /><circle cx="19" cy="5" r="2" /><circle cx="5" cy="19" r="2" /><circle cx="19" cy="19" r="2" /><path d="m6.5 6.5 3.6 3.6M17.5 6.5l-3.6 3.6M6.5 17.5l3.6-3.6M17.5 17.5l-3.6-3.6" /></S>;
export const IcoRouter = (p) => <S {...p}><rect x="3" y="13" width="18" height="7" rx="2" /><path d="M7 16.5h.01M11 16.5h6" /><path d="M8.5 9a5 5 0 0 1 7 0M6 6.2a9 9 0 0 1 12 0" /></S>;
