"""Демо-дашборд ML-моделей САМ ВКО: атрибуция причины и прогноз SLA.
...
st.caption("ML-атрибуция причины деградации канала и прогноз выхода за SLA на 6 часов вперёд.")
