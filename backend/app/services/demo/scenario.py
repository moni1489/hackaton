...
# код, район, провайдер, x, y (условная схема 0..100), договор Мбит/с (у всех 100: группы сравнимы), рабочих мест
SCHOOLS = [
    ("D01", N_DIST, NORD, 22, 20, 100, 3), ("D02", N_DIST, NORD, 34, 28, 100, 3),
    ("D03", N_DIST, NORD, 24, 38, 100, 2), ("D04", N_DIST, NORD, 42, 17, 100, 2),
    ("D05", N_DIST, STEP, 47, 35, 100, 3), ("D06", N_DIST, STEP, 12, 30, 100, 2),
    ("D07", R_DIST, NORD, 62, 58, 100, 2), ("D08", R_DIST, REKA, 76, 62, 100, 3),
    ("D09", R_DIST, REKA, 68, 76, 100, 2), ("D10", O_DIST, STEP, 22, 70, 100, 3),
    ("D11", O_DIST, STEP, 36, 84, 100, 2), ("D12", O_DIST, REKA, 46, 68, 100, 2),
]
ANCHOR = "D01"
